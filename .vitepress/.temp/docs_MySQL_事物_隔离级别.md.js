...
const __pageData = JSON.parse('{"title":"事务","description":"","frontmatter":{},"headers":[],"relativePath":"docs/MySQL/事物_隔离级别.md","filePath":"docs/MySQL/事物_隔离级别.md","lastUpdated":1717041105000}');
const _sfc_main = { name: "docs/MySQL/事物_隔离级别.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="事务" tabindex="-1">事务 <a class="header-anchor" href="#事务" aria-label="Permalink to &quot;事务&quot;">​</a></h1><h2 id="如果需要手动提交事务" tabindex="-1">如果需要手动提交事务 <a class="header-anchor" href="#如果需要手动提交事务" aria-label="Permalink to &quot;如果需要手动提交事务&quot;">​</a></h2><pre><code>	（1）set autocommit = false/0;
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("docs/MySQL/事物_隔离级别.md");
