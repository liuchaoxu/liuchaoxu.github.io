import { defineComponent, resolveComponent, useSSRContext, h, defineAsyncComponent, ref, onMounted, watchEffect, watch, onUnmounted, createSSRApp } from "vue";
import { L as Layout, _ as _sfc_main$1, i as inBrowser, c as createTitle, m as mergeHead, u as useRoute, p as pathToFile, a as useData, R as RouterSymbol, b as initData, d as dataSymbol, C as Content, s as siteDataRef, e as createRouter } from "./VPTeamMembers.CS6LHA8J.js";
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/component/AboutMeTop.vue");
...
const RawTheme = {
  ...
  enhanceApp({ app, router, siteData }) {
    app.component("AboutMeTop", _sfc_main);
    app.component("MyVideo", defineAsyncComponent(
      () => import("./MyVideo.D05MIIcN.js")
    ));
    app.component("VueUtterances", defineAsyncComponent(
      () => import("./VueUtterances.BxGFYui_.js")
    ));
  }
};
